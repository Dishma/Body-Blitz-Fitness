...
%>
  ...
  <h2>Update Your Information</h2>
    <form action="updatecustomer" method="post" class="form-group">
      
      	<label for="id"><b>User ID</b></label>
        <input type="text" placeholder="Enter ID" name="cusid" value="<%= id%>" readonly required>
        
      	<label for="name"><b>Name</b></label>
        <input type="text" placeholder="Enter Name" name="name" value="<%= name%>" required>
        
        <label for="email"><b>E-mail</b></label>
        <input type="text" placeholder="Enter E-mail" name="email" value="<%= email%>" required>
       
        <label for="phonenumber"><b>Phone Number</b></label>
        <input type="text" placeholder="Enter your PhoneNumber" name="phone" value="<%= phone%>" required>
        ...
        <button type="submit" value="Update" name="submit">Save</button>
